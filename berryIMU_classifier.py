...
while True:
    ...
    '''
    # for some reason it works when the left and rights are swapped? guess it just the orientation of the sensor?
    if (gyroXangle < -45 and gyroXangle > -90):
        print("Right tilt")
    if (gyroXangle > 45 and gyroXangle < 90):
        print("Left  tilt")

    if (AccXangle > accx_max or  AccXangle < accx_min):
        print("forward")
    #if (AccXangle > accx_max):
    #    print("forward")
    if (AccYangle > accy_max or AccYangle < accy_min):
        print("Lift")
    #if (AccYangle > accy_max):
     #   print("Lift")
